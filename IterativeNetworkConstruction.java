...
public abstract class IterativeNetworkConstruction{
	...
	public abstract LinkedList<User> firstPass(); //yields a list of users from our first sample of posts
	public abstract LinkedList<User> subsequentPass(User u); //does subsequent pass with a user as input
